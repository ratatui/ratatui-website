...
![RGB colors](https://raw.githubusercontent.com/ratatui-org/ratatui/images/examples/colors_rgb.gif)
...
println!("{:#?}", backend.window_size().unwrap());
```
...
One thing to note here is that multi-line content is converted to multiple spans with the new line removed.
...
-   Created [BREAKING-CHANGES.md](https://github.com/ratatui-org/ratatui/blob/main/BREAKING-CHANGES.md) for documenting the breaking changes in each version
