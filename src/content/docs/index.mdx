...
banner:
  content:
    Ratatui 0.26 has been released! <a href="https://ratatui.rs/highlights/v026/">Check it out
    here</a>!
---
...
<CardGrid stagger>
  ...
  <Card
    title="<a href='/tutorials/counter-app/single-function/'>Counter App Tutorial</a>"
    icon="document"
  />
