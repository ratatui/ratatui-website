...
hero:
  ...
  actions:
    - text: Hello World Tutorial
      ...
      icon: right-arrow
      variant: primary
    - text: <code>cargo add ratatui</code>
      link: /installation/
      icon: right-arrow
      variant: secondary
banner:
...
[Demo image]: https://raw.githubusercontent.com/ratatui-org/ratatui/images/examples/demo2.gif
[Demo source]: https://github.com/ratatui-org/ratatui/tree/main/examples/demo2
