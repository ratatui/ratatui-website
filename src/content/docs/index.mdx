...
title: "Ratatui"
description:
  "Ratatui: Cook up delicious terminal user interfaces in Rust - the fast and lightweight TUI library
      ...
      <div class="flex flex-wrap justify-between max-xl:justify-center gap-10 items-end max-w-[1440px] 2xl:w-[1440px] xl:w-[1280px] max-sm:w-[450px] max-xs:w-[300px]">
        <div class="max-xl:text-center">
          ...
          <div class="pb-5">
            ...
            <p class="text-lg max-sm:text-sm pt-5 leading-8 max-w-[600px]">Ratatui is a Rust library for building fast, lightweight, and rich terminal user interfaces 👨‍🍳🐀</p>
          </div>
