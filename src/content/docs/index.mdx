  ...
  <div>
      ...
      <div class="flex flex-wrap justify-between max-xl:justify-center gap-10 items-end max-w-[1440px] 2xl:w-[1440px] xl:w-[1280px] max-sm:w-[450px] max-xs:w-[300px]">
        <div class="max-xl:text-center">
          ...
          <div class="pb-5">
            ...
            <p class="text-lg max-sm:text-sm pt-5 leading-8 max-w-[600px]">Ratatui is a Rust library for building rich terminal user interfaces and applications.</p>
          </div>
    ...
    <div class="flex justify-center">
      <div class="max-w-[1440px] 2xl:w-[1440px] xl:w-[1280px] py-5 pt-[50px] max-xl:text-center">
        <p class="font-bold text-2xl max-xs:mx-3 text-blue-700 dark:!text-yellow-500">
    ...
    <div class="flex justify-center">
      <div class="flex justify-center gap-10 text-center py-10 w-screen bg-gradient-to-b from-blue-800 to-blue-200 dark:from-slate-950 dark:to-slate-950 mb-[-65px]">
        <div class="py-10">
          <h2 class="!text-6xl max-md:!text-3xl max-2xl:px-5 pb-10 !text-white">Ready to start <span class="landing-highlight-tall">cooking</span></h2>
          <p class="text-xl max-md:text-sm pb-5 max-2xl:px-5 text-white">Join thousands of <span class="dark:text-yellow-500">{`{developers}`}</span> cooking 🍳 up the next generation of terminal applications</p>
          <MainButtons
