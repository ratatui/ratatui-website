...
<div class="flex justify-center landing-mono pt-3 dark:pt-0">
  <div>
    ...
    <div class="flex justify-center mt-[-2rem]">
      <div class="flex flex-wrap justify-between max-xl:justify-center gap-10 xl:gap-3 items-end max-w-[1440px] 2xl:w-[1440px] xl:w-[1200px] max-sm:w-[450px] max-xs:w-[300px]">
        <div class="max-xl:text-center">
          ...
          <div class="pb-5">
            <p class="font-bold text-5xl max-2xl:text-4xl xl:text-4xl max-sm:text-3xl text-black dark:text-white">Cook up <span class="landing-highlight">delicious</span></p>
            <p class="font-bold text-5xl max-2xl:text-4xl xl:text-4xl max-sm:text-3xl text-black dark:text-white">terminal user interfaces.</p>
    ...
    <div class="flex justify-center">
      <div class="max-w-[1440px] 2xl:w-[1440px] xl:w-[1200px] py-5 pt-[50px] max-xl:text-center">
    ...
    <div class="flex justify-center m-auto max-w-[1440px] 2xl:w-[1440px] xl:w-[1200px] max-xl:text-center">
      <div>
        <ShowcaseCards />
    ...
    <div class="flex justify-center pt-[5rem] m-auto max-w-[1440px] 2xl:w-[1440px] xl:w-[1200px] max-xl:text-center">
      <Features />
    </div>
    ...
    <div class="flex justify-center">
      <div class="flex justify-center gap-10 text-center py-10 w-[calc(100vw-15px)] bg-gradient-to-b from-slate-500 to-slate-300 dark:from-slate-950 dark:to-slate-950 mb-[-65px]">
        <div class="py-10">
