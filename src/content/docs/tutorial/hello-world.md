...
application which displays a colored message the middle of the screen and waits for the user to press
a key to exit.
...
[panic hooks how-to]: /how-to/develop-apps/setup-panic-hooks/
