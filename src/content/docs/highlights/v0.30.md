...
[`ratatui::run()`](#execution-%EF%B8%8F) API, and brought major [widget](#widgets) and
[layout](#layout) improvements — all with better [backend](#backend-%EF%B8%8F) flexibility and
