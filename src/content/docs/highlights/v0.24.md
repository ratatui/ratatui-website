...
⚠️ We created a
[breaking changes](https://github.com/ratatui/ratatui/blob/main/BREAKING-CHANGES.md) document
...
> The code is available
> [here](https://github.com/ratatui/ratatui/blob/main/examples/colors_rgb.rs).
