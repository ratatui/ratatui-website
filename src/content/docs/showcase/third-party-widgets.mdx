...
[Third Party Widgets README](https://github.com/ratatui/ratatui-website/tree/main/code/widget-showcase-third-party/README.md)
...
throbber. Also-known-as an activity indicator, progress bar, loading icon, spinner, or ぐるぐる
(guru guru).
